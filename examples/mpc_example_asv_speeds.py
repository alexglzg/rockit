...
current_X = vertcat(0.001, 0.0, 0.1)  # initial state

u_ref = 0.7
r_ref = 0.2
final_X   = vertcat(u_ref, 0, r_ref)    # desired terminal state
...
X = vertcat(u, v, r)
ocp.add_objective(ocp.integral(0.1*(u-u_ref)**2 + 0.2*(r-r_ref)**2))
