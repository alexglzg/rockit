...
ocp.add_objective(ocp.integral(0.8*(ye-ye_ref)**2 + 0.3*(sinpsi-sinpsi_ref)**2 + 0.3*(cospsi-cospsi_ref)**2 + 80*(u-u_ref)**2 + 0.0001*Tstbd**2 + 0.0001*Tport**2))
ocp.add_objective(ocp.at_tf(1*(ye-ye_ref)**2 + 0.5*(sinpsi-sinpsi_ref)**2 + 0.5*(cospsi-cospsi_ref)**2 + 100*(u-u_ref)**2 + 0.0005*Tstbd**2 + 0.0005*Tport**2))
