...
value = (x_prime**2) / (obstacle_a**2) + (y_prime**2) / (obstacle_b**2)
ocp.subject_to(value > 1)
...
ocpf.set_initial(u1, 0)
ocpf.set_initial(u2, 0)
ocpf.set_initial(u3, 0)
ocpf.set_initial(u4, 0)
    

ocpf._method.set_name("path_following_avoidance")
