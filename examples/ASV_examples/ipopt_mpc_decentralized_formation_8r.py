...
Nsim  = int(60 * Nhor / Tf)                 # how much samples to simulate
...
ocpX1.set_der(y1, v1)
# Lagrange objective
ocpX1.add_objective(ocpX1.sum(20*(xd_1-x1)**2 + 20*(yd_1-y1)**2))
ocpX1.add_objective(ocpX1.at_tf(20*(xd_1-x1)**2 + 20*(yd_1-y1)**2))
...
ocp_ipopt.solver('ipopt',options)
# Make it concrete for this ocp
ocp_ipopt.method(MultipleShooting(N=Nhor,M=1,intg='rk'))

# Dynamics declaration
Sim_asv_dyn = ocpX1._method.discrete_system(ocp_ipopt)

#method = external_method('fatrop',N=Nhor, intg='rk')
#ocpX1.method(method)
#ocpX1._method.set_name("x1")
...
'''
ocpZ1 = Ocp(T=Tf)
stupid_state = ocpZ1.state()
ocpZ1.set_der(stupid_state, 0)
ocpZ1.add_objective(ocpZ1.sum(stupid_state**2))
# Variables
z1_x1 = ocpZ1.control()
z1_y1 = ocpZ1.control()
...
if ocpZ1.is_signal(Z1_term1):
    Z1_term1 = ocpZ1.sum(Z1_term1,include_last=False)
...
if ocpZ1.is_signal(Z1_term2):
    Z1_term2 = ocpZ1.sum(Z1_term2,include_last=False)
...
if ocpZ1.is_signal(Z1_term3):
    Z1_term3 = ocpZ1.sum(Z1_term3,include_last=False)
...
if ocpZ1.is_signal(Z1_term4):
    Z1_term4 = ocpZ1.sum(Z1_term4,include_last=False)
...
if ocpZ1.is_signal(Z1_term5):
    Z1_term5 = ocpZ1.sum(Z1_term5,include_last=False)
...
if ocpZ1.is_signal(Z1_term6):
    Z1_term6 = ocpZ1.sum(Z1_term6,include_last=False)
...
if ocpZ1.is_signal(Z1_term7):
    Z1_term7 = ocpZ1.sum(Z1_term7,include_last=False)
...
if ocpZ1.is_signal(Z1_term8):
    Z1_term8 = ocpZ1.sum(Z1_term8,include_last=False)
...
ocpX2.set_der(y2, v2)
# Lagrange objective
ocpX2.add_objective(ocpX2.sum(20*(xd_2-x2)**2 + 20*(yd_2-y2)**2))
ocpX2.add_objective(ocpX2.at_tf(20*(xd_2-x2)**2 + 20*(yd_2-y2)**2))
...
#ocpX2.method(method)
#ocpX2._method.set_name("x2")

'''
OcpZ2
'''
ocpZ2 = Ocp(T=Tf)
stupid_state = ocpZ2.state()
ocpZ2.set_der(stupid_state, 0)
ocpZ2.add_objective(ocpZ2.sum(stupid_state**2))
# Variables
z2_x1 = ocpZ2.control()
z2_y1 = ocpZ2.control()
...
if ocpZ2.is_signal(Z2_term1):
    Z2_term1 = ocpZ2.sum(Z2_term1,include_last=False)
...
if ocpZ2.is_signal(Z2_term2):
    Z2_term2 = ocpZ2.sum(Z2_term2,include_last=False)
...
if ocpZ2.is_signal(Z2_term3):
    Z2_term3 = ocpZ2.sum(Z2_term3,include_last=False)
...
if ocpZ2.is_signal(Z2_term4):
    Z2_term4 = ocpZ2.sum(Z2_term4,include_last=False)
...
if ocpZ2.is_signal(Z2_term5):
    Z2_term5 = ocpZ2.sum(Z2_term5,include_last=False)
...
if ocpZ2.is_signal(Z2_term6):
    Z2_term6 = ocpZ2.sum(Z2_term6,include_last=False)
...
if ocpZ2.is_signal(Z2_term7):
    Z2_term7 = ocpZ2.sum(Z2_term7,include_last=False)
...
if ocpZ2.is_signal(Z2_term8):
    Z2_term8 = ocpZ2.sum(Z2_term8,include_last=False)
...
ocpX3.set_der(y3, v3)
# Lagrange objective
ocpX3.add_objective(ocpX3.sum(20*(xd_3-x3)**2 + 20*(yd_3-y3)**2))
ocpX3.add_objective(ocpX3.at_tf(20*(xd_3-x3)**2 + 20*(yd_3-y3)**2))
...
'''
ocpZ3 = Ocp(T=Tf)
stupid_state = ocpZ3.state()
ocpZ3.set_der(stupid_state, 0)
ocpZ3.add_objective(ocpZ3.sum(stupid_state**2))
# Variables
z3_x1 = ocpZ3.control()
z3_y1 = ocpZ3.control()
...
if ocpZ3.is_signal(Z3_term1):
    Z3_term1 = ocpZ3.sum(Z3_term1,include_last=False)
...
if ocpZ3.is_signal(Z3_term2):
    Z3_term2 = ocpZ3.sum(Z3_term2,include_last=False)
...
if ocpZ3.is_signal(Z3_term3):
    Z3_term3 = ocpZ3.sum(Z3_term3,include_last=False)
...
if ocpZ3.is_signal(Z3_term4):
    Z3_term4 = ocpZ3.sum(Z3_term4,include_last=False)
...
if ocpZ3.is_signal(Z3_term5):
    Z3_term5 = ocpZ3.sum(Z3_term5,include_last=False)
...
if ocpZ3.is_signal(Z3_term6):
    Z3_term6 = ocpZ3.sum(Z3_term6,include_last=False)
...
if ocpZ3.is_signal(Z3_term7):
    Z3_term7 = ocpZ3.sum(Z3_term7,include_last=False)
...
if ocpZ3.is_signal(Z3_term8):
    Z3_term8 = ocpZ3.sum(Z3_term8,include_last=False)
...
ocpX4.set_der(y4, v4)
# Lagrange objective
ocpX4.add_objective(ocpX4.sum(20*(xd_4-x4)**2 + 20*(yd_4-y4)**2))
ocpX4.add_objective(ocpX4.at_tf(20*(xd_4-x4)**2 + 20*(yd_4-y4)**2))
...
'''
ocpZ4 = Ocp(T=Tf)
stupid_state = ocpZ4.state()
ocpZ4.set_der(stupid_state, 0)
ocpZ4.add_objective(ocpZ4.sum(stupid_state**2))
# Variables
z4_x1 = ocpZ4.control()
z4_y1 = ocpZ4.control()
...
if ocpZ4.is_signal(Z4_term1):
    Z4_term1 = ocpZ4.sum(Z4_term1,include_last=False)
...
if ocpZ4.is_signal(Z4_term2):
    Z4_term2 = ocpZ4.sum(Z4_term2,include_last=False)
...
if ocpZ4.is_signal(Z4_term3):
    Z4_term3 = ocpZ4.sum(Z4_term3,include_last=False)
...
if ocpZ4.is_signal(Z4_term4):
    Z4_term4 = ocpZ4.sum(Z4_term4,include_last=False)
...
if ocpZ4.is_signal(Z4_term5):
    Z4_term5 = ocpZ4.sum(Z4_term5,include_last=False)
...
if ocpZ4.is_signal(Z4_term6):
    Z4_term6 = ocpZ4.sum(Z4_term6,include_last=False)
...
if ocpZ4.is_signal(Z4_term7):
    Z4_term7 = ocpZ4.sum(Z4_term7,include_last=False)
...
if ocpZ4.is_signal(Z4_term8):
    Z4_term8 = ocpZ4.sum(Z4_term8,include_last=False)
...
ocpX5.set_der(y5, v5)
# Lagrange objective
ocpX5.add_objective(ocpX5.sum(20*(xd_5-x5)**2 + 20*(yd_5-y5)**2))
ocpX5.add_objective(ocpX5.at_tf(20*(xd_5-x5)**2 + 20*(yd_5-y5)**2))
...
'''
ocpZ5 = Ocp(T=Tf)
stupid_state = ocpZ5.state()
ocpZ5.set_der(stupid_state, 0)
ocpZ5.add_objective(ocpZ5.sum(stupid_state**2))
# Variables
z5_x1 = ocpZ5.control()
z5_y1 = ocpZ5.control()
...
if ocpZ5.is_signal(Z5_term1):
    Z5_term1 = ocpZ5.sum(Z5_term1,include_last=False)
...
if ocpZ5.is_signal(Z5_term2):
    Z5_term2 = ocpZ5.sum(Z5_term2,include_last=False)
...
if ocpZ5.is_signal(Z5_term3):
    Z5_term3 = ocpZ5.sum(Z5_term3,include_last=False)
...
if ocpZ5.is_signal(Z5_term4):
    Z5_term4 = ocpZ5.sum(Z5_term4,include_last=False)
...
if ocpZ5.is_signal(Z5_term5):
    Z5_term5 = ocpZ5.sum(Z5_term5,include_last=False)
...
if ocpZ5.is_signal(Z5_term6):
    Z5_term6 = ocpZ5.sum(Z5_term6,include_last=False)
...
if ocpZ5.is_signal(Z5_term7):
    Z5_term7 = ocpZ5.sum(Z5_term7,include_last=False)
...
if ocpZ5.is_signal(Z5_term8):
    Z5_term8 = ocpZ5.sum(Z5_term8,include_last=False)
...
ocpX6.set_der(y6, v6)
# Lagrange objective
ocpX6.add_objective(ocpX6.sum(20*(xd_6-x6)**2 + 20*(yd_6-y6)**2))
ocpX6.add_objective(ocpX6.at_tf(20*(xd_6-x6)**2 + 20*(yd_6-y6)**2))
...
'''
ocpZ6 = Ocp(T=Tf)
stupid_state = ocpZ6.state()
ocpZ6.set_der(stupid_state, 0)
ocpZ6.add_objective(ocpZ6.sum(stupid_state**2))
# Variables
z6_x1 = ocpZ6.control()
z6_y1 = ocpZ6.control()
...
if ocpZ6.is_signal(Z6_term1):
    Z6_term1 = ocpZ6.sum(Z6_term1,include_last=False)
...
if ocpZ6.is_signal(Z6_term2):
    Z6_term2 = ocpZ6.sum(Z6_term2,include_last=False)
...
if ocpZ6.is_signal(Z6_term3):
    Z6_term3 = ocpZ6.sum(Z6_term3,include_last=False)
...
if ocpZ6.is_signal(Z6_term4):
    Z6_term4 = ocpZ6.sum(Z6_term4,include_last=False)
...
if ocpZ6.is_signal(Z6_term5):
    Z6_term5 = ocpZ6.sum(Z6_term5,include_last=False)
...
if ocpZ6.is_signal(Z6_term6):
    Z6_term6 = ocpZ6.sum(Z6_term6,include_last=False)
...
if ocpZ6.is_signal(Z6_term7):
    Z6_term7 = ocpZ6.sum(Z6_term7,include_last=False)
...
if ocpZ6.is_signal(Z6_term8):
    Z6_term8 = ocpZ6.sum(Z6_term8,include_last=False)
...
ocpX7.set_der(y7, v7)
# Lagrange objective
ocpX7.add_objective(ocpX7.sum(20*(xd_7-x7)**2 + 20*(yd_7-y7)**2))
ocpX7.add_objective(ocpX7.at_tf(20*(xd_7-x7)**2 + 20*(yd_7-y7)**2))
...
'''
ocpZ7 = Ocp(T=Tf)
stupid_state = ocpZ7.state()
ocpZ7.set_der(stupid_state, 0)
ocpZ7.add_objective(ocpZ7.sum(stupid_state**2))
# Variables
z7_x1 = ocpZ7.control()
z7_y1 = ocpZ7.control()
...
if ocpZ7.is_signal(Z7_term1):
    Z7_term1 = ocpZ7.sum(Z7_term1,include_last=False)
...
if ocpZ7.is_signal(Z7_term2):
    Z7_term2 = ocpZ7.sum(Z7_term2,include_last=False)
...
if ocpZ7.is_signal(Z7_term3):
    Z7_term3 = ocpZ7.sum(Z7_term3,include_last=False)
...
if ocpZ7.is_signal(Z7_term4):
    Z7_term4 = ocpZ7.sum(Z7_term4,include_last=False)
...
if ocpZ7.is_signal(Z7_term5):
    Z7_term5 = ocpZ7.sum(Z7_term5,include_last=False)
...
if ocpZ7.is_signal(Z7_term6):
    Z7_term6 = ocpZ7.sum(Z7_term6,include_last=False)
...
if ocpZ7.is_signal(Z7_term7):
    Z7_term7 = ocpZ7.sum(Z7_term7,include_last=False)
...
if ocpZ7.is_signal(Z7_term8):
    Z7_term8 = ocpZ7.sum(Z7_term8,include_last=False)
...
ocpX8.set_der(y8, v8)
# Lagrange objective
ocpX8.add_objective(ocpX8.sum(20*(xd_8-x8)**2 + 20*(yd_8-y8)**2))
ocpX8.add_objective(ocpX8.at_tf(20*(xd_8-x8)**2 + 20*(yd_8-y8)**2))
...
'''
ocpZ8 = Ocp(T=Tf)
stupid_state = ocpZ8.state()
ocpZ8.set_der(stupid_state, 0)
ocpZ8.add_objective(ocpZ8.sum(stupid_state**2))
# Variables
z8_x1 = ocpZ8.control()
z8_y1 = ocpZ8.control()
...
if ocpZ8.is_signal(Z8_term1):
    Z8_term1 = ocpZ8.sum(Z8_term1,include_last=False)
...
if ocpZ8.is_signal(Z8_term2):
    Z8_term2 = ocpZ8.sum(Z8_term2,include_last=False)
...
if ocpZ8.is_signal(Z8_term3):
    Z8_term3 = ocpZ8.sum(Z8_term3,include_last=False)
...
if ocpZ8.is_signal(Z8_term4):
    Z8_term4 = ocpZ8.sum(Z8_term4,include_last=False)
...
if ocpZ8.is_signal(Z8_term5):
    Z8_term5 = ocpZ8.sum(Z8_term5,include_last=False)
...
if ocpZ8.is_signal(Z8_term6):
    Z8_term6 = ocpZ8.sum(Z8_term6,include_last=False)
...
if ocpZ8.is_signal(Z8_term7):
    Z8_term7 = ocpZ8.sum(Z8_term7,include_last=False)
...
if ocpZ8.is_signal(Z8_term8):
    Z8_term8 = ocpZ8.sum(Z8_term8,include_last=False)
