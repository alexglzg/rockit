...
int sampler_u(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem);
int sampler_u_alloc_mem(void);
int sampler_u_init_mem(int mem);
void sampler_u_free_mem(int mem);
int sampler_u_checkout(void);
void sampler_u_release(int mem);
void sampler_u_incref(void);
void sampler_u_decref(void);
casadi_int sampler_u_n_in(void);
casadi_int sampler_u_n_out(void);
casadi_real sampler_u_default_in(casadi_int i);
const char* sampler_u_name_in(casadi_int i);
const char* sampler_u_name_out(casadi_int i);
const casadi_int* sampler_u_sparsity_in(casadi_int i);
const casadi_int* sampler_u_sparsity_out(casadi_int i);
int sampler_u_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w);
#define sampler_u_SZ_ARG 4
#define sampler_u_SZ_RES 1
#define sampler_u_SZ_IW 0
#define sampler_u_SZ_W 1
int sampler_v(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem);
int sampler_v_alloc_mem(void);
int sampler_v_init_mem(int mem);
void sampler_v_free_mem(int mem);
int sampler_v_checkout(void);
void sampler_v_release(int mem);
void sampler_v_incref(void);
void sampler_v_decref(void);
casadi_int sampler_v_n_in(void);
casadi_int sampler_v_n_out(void);
casadi_real sampler_v_default_in(casadi_int i);
const char* sampler_v_name_in(casadi_int i);
const char* sampler_v_name_out(casadi_int i);
const casadi_int* sampler_v_sparsity_in(casadi_int i);
const casadi_int* sampler_v_sparsity_out(casadi_int i);
int sampler_v_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w);
#define sampler_v_SZ_ARG 4
#define sampler_v_SZ_RES 1
#define sampler_v_SZ_IW 0
#define sampler_v_SZ_W 1
#ifdef __cplusplus
} /* extern "C" */
#endif
