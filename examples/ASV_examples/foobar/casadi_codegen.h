...
int sampler_Urdot(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem);
int sampler_Urdot_alloc_mem(void);
int sampler_Urdot_init_mem(int mem);
void sampler_Urdot_free_mem(int mem);
int sampler_Urdot_checkout(void);
void sampler_Urdot_release(int mem);
void sampler_Urdot_incref(void);
void sampler_Urdot_decref(void);
casadi_int sampler_Urdot_n_out(void);
casadi_int sampler_Urdot_n_in(void);
casadi_real sampler_Urdot_default_in(casadi_int i);
const char* sampler_Urdot_name_in(casadi_int i);
const char* sampler_Urdot_name_out(casadi_int i);
const casadi_int* sampler_Urdot_sparsity_in(casadi_int i);
const casadi_int* sampler_Urdot_sparsity_out(casadi_int i);
int sampler_Urdot_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w);
int sampler_r(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem);
int sampler_r_alloc_mem(void);
int sampler_r_init_mem(int mem);
void sampler_r_free_mem(int mem);
int sampler_r_checkout(void);
void sampler_r_release(int mem);
void sampler_r_incref(void);
void sampler_r_decref(void);
casadi_int sampler_r_n_out(void);
casadi_int sampler_r_n_in(void);
casadi_real sampler_r_default_in(casadi_int i);
const char* sampler_r_name_in(casadi_int i);
const char* sampler_r_name_out(casadi_int i);
const casadi_int* sampler_r_sparsity_in(casadi_int i);
const casadi_int* sampler_r_sparsity_out(casadi_int i);
int sampler_r_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w);
int sampler_s(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem);
int sampler_s_alloc_mem(void);
int sampler_s_init_mem(int mem);
void sampler_s_free_mem(int mem);
int sampler_s_checkout(void);
void sampler_s_release(int mem);
void sampler_s_incref(void);
void sampler_s_decref(void);
casadi_int sampler_s_n_out(void);
casadi_int sampler_s_n_in(void);
casadi_real sampler_s_default_in(casadi_int i);
const char* sampler_s_name_in(casadi_int i);
const char* sampler_s_name_out(casadi_int i);
const casadi_int* sampler_s_sparsity_in(casadi_int i);
const casadi_int* sampler_s_sparsity_out(casadi_int i);
int sampler_s_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w);
int sampler_s_min(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem);
int sampler_s_min_alloc_mem(void);
int sampler_s_min_init_mem(int mem);
void sampler_s_min_free_mem(int mem);
int sampler_s_min_checkout(void);
void sampler_s_min_release(int mem);
void sampler_s_min_incref(void);
void sampler_s_min_decref(void);
casadi_int sampler_s_min_n_out(void);
casadi_int sampler_s_min_n_in(void);
casadi_real sampler_s_min_default_in(casadi_int i);
const char* sampler_s_min_name_in(casadi_int i);
const char* sampler_s_min_name_out(casadi_int i);
const casadi_int* sampler_s_min_sparsity_in(casadi_int i);
const casadi_int* sampler_s_min_sparsity_out(casadi_int i);
int sampler_s_min_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w);
#ifdef __cplusplus
} /* extern "C" */
#endif
