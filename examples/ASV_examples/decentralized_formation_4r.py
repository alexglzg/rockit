...
Z1_distance4 = (z1_x2-z1_x3)**2 + (z1_y2-z1_y3)**2
Z1_distance5 = (z1_x2-z1_x4)**2 + (z1_y2-z1_y4)**2
Z1_distance6 = (z1_x3-z1_x4)**2 + (z1_y3-z1_y4)**2
...
Z2_distance2 = (z2_x1-z2_x3)**2 + (z2_y1-z2_y3)**2
Z2_distance3 = (z2_x1-z2_x4)**2 + (z2_y1-z2_y4)**2
Z2_distance4 = (z2_x2-z2_x3)**2 + (z2_y2-z2_y3)**2
Z2_distance5 = (z2_x2-z2_x4)**2 + (z2_y2-z2_y4)**2
Z2_distance6 = (z2_x3-z2_x4)**2 + (z2_y3-z2_y4)**2
...
# Constraints
Z3_distance1 = (z3_x1-z3_x2)**2 + (z3_y1-z3_y2)**2
Z3_distance2 = (z3_x1-z3_x3)**2 + (z3_y1-z3_y3)**2
Z3_distance3 = (z3_x1-z3_x4)**2 + (z3_y1-z3_y4)**2
Z3_distance4 = (z3_x2-z3_x3)**2 + (z3_y2-z3_y3)**2
Z3_distance5 = (z3_x2-z3_x4)**2 + (z3_y2-z3_y4)**2
...
# Constraints
Z4_distance1 = (z4_x1-z4_x2)**2 + (z4_y1-z4_y2)**2
Z4_distance2 = (z4_x1-z4_x3)**2 + (z4_y1-z4_y3)**2
Z4_distance3 = (z4_x1-z4_x4)**2 + (z4_y1-z4_y4)**2
Z4_distance4 = (z4_x2-z4_x3)**2 + (z4_y2-z4_y3)**2
...
for i in range(ND):
    ...
    print("iteration", i+1, "of", ND, residuals)


fig1, ax1 = plt.subplots()
ax1.plot(X1p[1], X1p[0], 'bo')
ax1.plot(X2p[1], X2p[0], 'r-')
ax1.plot(X3p[1], X3p[0], 'g--')
ax1.plot(X4p[1], X4p[0], 'c.-')
ax1.set_xlabel('Y [m]')
ax1.set_ylabel('X [m]')
plt.axis(equal=True)
